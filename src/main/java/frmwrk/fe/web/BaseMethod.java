...
public class BaseMethod extends WebDriverFactory {
	...
	public void getpasswordtesting() throws Exception{
	...
	//1000
	public void scrollDown1000() throws InterruptedException {
		((JavascriptExecutor) getWebDriver()).executeScript("scroll(0, 1000);");
		Thread.sleep(500);
	}

	public void scrollToCenter(WebElement m) throws InterruptedException {
		waitForVisibility(m);
		((JavascriptExecutor) getWebDriver()).executeScript("arguments[0].scrollIntoView({block: 'center', inline: 'nearest'})", m);
	}

	public void scrollToElement(WebElement e) throws Exception {
		waitForVisibility(e);
		((JavascriptExecutor) getWebDriver()).executeScript("arguments[0].scrollIntoView();", e);
	}

	public boolean isElementDisplayed(WebElement e){
//		new WebDriverWait(getWebDriver(), Duration.ofSeconds(WAIT));
		try {
	...
	public String decryptData(String decrptData)
	{
