...
public class T33176 extends AdminLoginCommerce1PageObject {
    //============== Login ==================//
   ...
   private WebElement expectedT33172;
    ...
    public T33176 InputEmail() throws InterruptedException {
        Thread.sleep(1000);
    ...
    public T33176 btnLogin() throws InterruptedException {
    ...
    public T33176 hdrmn() throws InterruptedException {
    ...
    public T33176 subhdrmn() throws InterruptedException {
    ...
    public T33176 btnEdit() throws InterruptedException {
...
//        btnEditlstmn.click();
    ...
    public T33176 addnewbrand() throws InterruptedException {
    ...
    public T33176 txtareabrndNm() throws InterruptedException {
    ...
    public T33176 upldfile2() throws Exception {
    ...
    public T33176 btnaddbrand() throws InterruptedException {
    ...
    public T33176 btnSave() throws InterruptedException {
    ...
    public T33176 ExpectedT33176() throws Exception {
        highlightElement(btnEditlstmn);
        Thread.sleep(3000);
        AllureAttachments.saveWebElement(getWebDriver(), btnEditlstmn);
        Thread.sleep(3000);
        JSclick(btnEditlstmn);
        Thread.sleep(3000);
        robotScreenCapture("ExpectedT33176");
        Thread.sleep(5000);
        return this;
    }
