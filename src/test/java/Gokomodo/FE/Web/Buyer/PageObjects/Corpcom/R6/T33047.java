...
public class T33047 extends BuyerLoginCommerce1PageObject {
    ...
    private WebElement inquirychooseWFR;
    ...
    public T33047 InputEmail() throws InterruptedException {
        Thread.sleep(1000);
    ...
    public T33047 BtnLoginCorp() throws InterruptedException {
    ...
    public T33047 clickLogoRFQBtnCorpcomm() {
    ...
    public T33047 clickUploadedbtnCorpcomm() throws InterruptedException {
    ...
    public T33047 inquiryListClickCorpcomm() {
    ...
    public T33047 inquirychooseWFRCorpcomm() throws InterruptedException {
        highlightElement(inquirychooseWFR);
        inquirychooseWFR.click();
        Thread.sleep(4000);
        return this;
    }

    @Step("As a user choose click the RFQ detail")
    public T33047 clickRFQListCorpcomm() {
    ...
    public T33047 clickActionbtnCorpcomm() {
    ...
    public T33047 clickCancelBtnCorpcomm() {
    ...
    public T33047 inputReasonCancelCorpcomm() {
        highlightElement(inputReasonCancel);
        inputReasonCancel.sendKeys("testing testcase T33047");
        return this;
    }

    @Step("As a user click the cancel button")
    public T33047 clickCancelPopUpCorpcomm() throws Exception {
        highlightElement(clickCancelPopUp);
        clickCancelPopUp.click();
        Thread.sleep(3000);
        AllureAttachments.saveWebElement(getWebDriver(), clickCancelPopUp);
        Thread.sleep(3000);
        robotScreenCapture("ExpectedT33047");
        return this;
    }
