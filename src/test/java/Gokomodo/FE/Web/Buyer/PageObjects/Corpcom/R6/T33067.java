...
public class T33067 extends BuyerLoginCommerce1PageObject {
    ...
    @FindBy(id = "react-select-5-option-5")
    private WebElement inquirychoosePO;
    ...
    public T33067 InputEmail() throws InterruptedException {
        Thread.sleep(1000);
    ...
    public T33067 BtnLoginCorp() throws InterruptedException {
    ...
    public T33067 clickLogoRFQBtnCorpcomm() {
    ...
    public T33067 clickUploadedbtnCorpcomm() throws InterruptedException {
    ...
    public T33067 inquiryListClickCorpcomm() {
    ...
    public T33067 inquirychoosePOCorpcomm() throws InterruptedException {
        highlightElement(inquirychoosePO);
        inquirychoosePO.click();
        Thread.sleep(4000);
        return this;
    }

    @Step("As a user choose click the RFQ detail")
    public T33067 clickRFQListCorpcomm() {
