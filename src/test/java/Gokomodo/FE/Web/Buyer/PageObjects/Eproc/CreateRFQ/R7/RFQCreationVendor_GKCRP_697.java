...
import Gokomodo.GlobalMethod.Utils.DateAndTime;
import Gokomodo.GlobalMethod.Utils.RandomGenerator;
...
public class RFQCreationVendor_GKCRP_697 extends BuyerLoginNauseee1PageObject {
    ...
    //--
    @FindBy(xpath = "//*[@id=\"root\"]/div/main/div/div[3]/div/div/div[4]/div/button")
    private WebElement btnAvailableSeller;
    //
    @FindBy(xpath = "/html/body/div[3]/div/div[1]/div/div/div[2]/div/div/div[1]/div/div/div[2]/input")
    private WebElement inputVendorSeller;
    //
    @FindBy(xpath = "/html/body/div[3]/div/div[1]/div/div/div[2]/div/div/div[1]/button")
    private WebElement btnClearFilter;
    //
    @FindBy(xpath = "/html/body/div[3]/div/div[1]/div/div/div[2]/div/div/ul/li[58]")
    private WebElement ScrollAvailableSeller;
    //
    @FindBy(css = ".close > span:nth-child(1)")
    private WebElement btnCloseAvailableClose;
    //
    @FindBy(xpath = "/html/body/div[1]/div/main/div/div[3]/div/div/div[5]/div[1]/div/div/div[1]/div[1]")
    private WebElement SelectDepartment;
    //
    @FindBy(id = "react-select-4-option-0")
    private WebElement SelectDepartmentDropdownList;
    //
    @FindBy(xpath = "/html/body/div[1]/div/main/div/div[3]/div/div/div[6]/div[2]/label/input")
    private WebElement RdPriority;
    //
    @FindBy(xpath = "/html/body/div[1]/div/main/div/div[3]/div/div/div[7]/div/div/button[2]")
...
//    @FindBy(id = "react-select-9-option-0")
    ...
    public RFQCreationVendor_GKCRP_697 InputEmailEproc() throws InterruptedException {
        Thread.sleep(1000);
        highlightElement(inputEmail);
        inputEmail.sendKeys(decryptData(usrNausee));
        return this;
    }

    @Step("As a user already input password")
    public RFQCreationVendor_GKCRP_697 InputPasswordEproc(){
    ...
    public RFQCreationVendor_GKCRP_697 BtnEprocLoginEproc(){
    ...
    public RFQCreationVendor_GKCRP_697 BtnEprocCreateNew() {
    ...
    public RFQCreationVendor_GKCRP_697 BtnEprocCreateNewRFQ() {
    ...
    public RFQCreationVendor_GKCRP_697 TboxSubjectRFQ() {
        highlightElement(SubjectRFQbox);
        SubjectRFQbox.sendKeys(RandomGenerator.GenerateRandomAlphaNumericCharacters(16));
        return this;
    }

    @Step("As user choose the category of RFQ")
    public RFQCreationVendor_GKCRP_697 TboxofCategory() {
    ...
    public RFQCreationVendor_GKCRP_697 TboxofDropdownListCategory() {
    ...
    public RFQCreationVendor_GKCRP_697 TboxofSubCategory() {
    ...
    public RFQCreationVendor_GKCRP_697 TboxofDropdownListSubCategory() {
    ...
    public RFQCreationVendor_GKCRP_697 ChecklistbuttonAllitemChoose() {
    ...
    @Step("Click the availability vendor from seller ")
    public RFQCreationVendor_GKCRP_697 btnAvailableSeller() throws InterruptedException {
        scrollDown1000();
        Thread.sleep(2000);
        highlightElement(btnAvailableSeller);
        btnAvailableSeller.click();
        return this;
    }

    @Step("input name of vendor from seller ")
    public RFQCreationVendor_GKCRP_697 inputVendorSeller() throws InterruptedException {
        Thread.sleep(2000);
        highlightElement(inputVendorSeller);
        inputVendorSeller.sendKeys("saka");
        Thread.sleep(2000);
        return this;
    }

    @Step("clean filter vendor from seller ")
    public RFQCreationVendor_GKCRP_697 btnClearFilter() throws InterruptedException {
        Thread.sleep(2000);
        highlightElement(btnClearFilter);
    ...
    @Step("clean filter vendor from seller ")
    public RFQCreationVendor_GKCRP_697 btnCloseAvailableClose() throws InterruptedException {
        Thread.sleep(2000);
        highlightElement(btnCloseAvailableClose);
        btnCloseAvailableClose.click();
        return this;
    }
...
//    }
    ...
    public RFQCreationVendor_GKCRP_697 TboxChooseDepartment() throws Exception {
        Thread.sleep(4000);
    ...
    public RFQCreationVendor_GKCRP_697 TboxChooseDropdownListDepartment() {
    ...
    @Step("As user choose department for create RFQ")
    public RFQCreationVendor_GKCRP_697 RdbuttonPriorityUrgent() {
    ...
    public RFQCreationVendor_GKCRP_697 BtnNextPagetoPage2() {
    ...
    public RFQCreationVendor_GKCRP_697 DeliveryMethodChooseFranco() {
    ...
    public RFQCreationVendor_GKCRP_697 ButtonAddProductforRFQ() throws InterruptedException {
    ...
    public RFQCreationVendor_GKCRP_697 TBoxInputCompanyNameforProduct(){
    ...
    public RFQCreationVendor_GKCRP_697 TboxDropdownChooseCompanyDelivery() throws InterruptedException {
        Thread.sleep(4000);
    ...
    public RFQCreationVendor_GKCRP_697 CompanyLocationforProductRFQ(){
    ...
    public RFQCreationVendor_GKCRP_697 DropdownListCompanyLocationforProductforRFQ() throws InterruptedException {
    ...
    public RFQCreationVendor_GKCRP_697 BtnAddProductUploadFileforRFQ() throws Exception {
    ...
    public RFQCreationVendor_GKCRP_697 BtnSaveAddProductforRFQ() {
    ...
    public RFQCreationVendor_GKCRP_697 DateChooseBoxCLick() throws InterruptedException {
        Thread.sleep(3000);
        scrollDown500();
        highlightElement(DateChooseBox);
        DateChooseBox.sendKeys(DateAndTime.getDate());
        return this;
    }

    @Step("As user click Date textbox for choose dateline RFQ")
    public RFQCreationVendor_GKCRP_697 TimeChooseBoxClick1() {
    ...
    public RFQCreationVendor_GKCRP_697 TimeChooseBoxClick2() {
    ...
    public RFQCreationVendor_GKCRP_697 StartdeliveryStartDateClick(){
        highlightElement(StartdeliveryStartDate);
        StartdeliveryStartDate.sendKeys("20 October '22");
        return this;
    }

    @Step("As user choose interval finish delivery the product")
    public RFQCreationVendor_GKCRP_697 StartdeliveryFinishDateClick(){
        highlightElement(StartdeliveryFinishDate);
        StartdeliveryFinishDate.sendKeys("20 November '22");
        return this;
    }
    ...
    public RFQCreationVendor_GKCRP_697 TermsOfPaymentsChooseClick() throws InterruptedException {
        Thread.sleep(4000);
        scrollDown700();
    ...
    public RFQCreationVendor_GKCRP_697 ListTermsOfPaymentsTboxChoose() {
    ...
    @Step("As user choose terms of payments box")
    public RFQCreationVendor_GKCRP_697 AdditionalNoteBoxFilled() {
    ...
    @Step("As user choose terms of payments box")
    public RFQCreationVendor_GKCRP_697 ButtonNextToPage3Click() {
    ...
    public RFQCreationVendor_GKCRP_697 ChooseVendorGokomodoRdButton() {
    ...
    public RFQCreationVendor_GKCRP_697 RdbuttonChooseAreaChecklistbutton() {
    ...
    public RFQCreationVendor_GKCRP_697 ChooseAllVendorSellerRdbutton() throws InterruptedException {
        Thread.sleep(4000);
        scrollDown700();
    ...
    public RFQCreationVendor_GKCRP_697 ButtonSummarytoPage4Click() throws InterruptedException {
    ...
    public RFQCreationVendor_GKCRP_697 ButtonSubmitRFQBuyerEprocClick() throws InterruptedException {
    ...
    @Step("As user click the button Submit RFQ")
    public RFQCreationVendor_GKCRP_697 ButtonPopUpSubmitRFQBuyerEprocClick() {
    ...
    @Step("As user click the button Submit RFQ")
    public RFQCreationVendor_GKCRP_697 buttonBackToMenuBuyer() {
    ...
    public RFQCreationVendor_GKCRP_697 lblSuccessCreateEproc() throws Exception {
