...
public class T33055 extends BuyerLoginCommerce1PageObject {
    ...
    public T33055 InputEmail() throws InterruptedException {
        Thread.sleep(1000);
    ...
    public T33055 BtnLoginCorp() throws InterruptedException {
    ...
    public T33055 clickLogoRFQBtnCorpcomm() {
    ...
    public T33055 inputRFQNameCorpcomm() {
    ...
    public T33055 clickTheRFQNameCorpcomm() {
    ...
    public T33055 clickActionbtnCorpcomm() {
    ...
    public T33055 clickCancelbtnCorpcomm() {
    ...
    @Step("As a user Input RFQ name RFQ/2022/09/135")
    public T33055 inputTextReasonCorpcomm() throws InterruptedException {
        highlightElement(inputTextReason);
        inputTextReason.sendKeys("Testing Automated");
        Thread.sleep(5000);
        return this;
    }

    @Step("As a user Input RFQ name RFQ/2022/09/135")
    public T33055 inputTextReasonCorpcomm2() throws Exception {
        highlightElement(inputTextReason);
        inputTextReason.sendKeys("Testing Automated by GATE for automating stuff. We assume Automation really help our team QA to make it easier to completed the task");
        Thread.sleep(3000);
        AllureAttachments.saveWebElement(getWebDriver(), inputTextReason);
        Thread.sleep(3000);
        robotScreenCapture("ExpectedT33055");
        return this;
    }
