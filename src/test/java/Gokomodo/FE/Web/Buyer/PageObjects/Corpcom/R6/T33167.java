...
public class T33167 extends BuyerLoginCommerce1PageObject {
    //============== Login ==================//
...
//    private WebElement clkprd;
    ...
    private WebElement resultsearch;
        ...
        public T33167 InputEmail() throws InterruptedException {
            Thread.sleep(1000);
        ...
        public T33167 BtnLoginCorp() throws InterruptedException {
         ...
         public T33167 searchPrd() throws InterruptedException {
            highlightElement(SearchProduct);
             AllureAttachments.saveWebElement(getWebDriver(), SearchProduct);
             SearchProduct.sendKeys("ban", Keys.ENTER);
            Thread.sleep(5000);
            return this;
        }
        @Step ("T33167 - the Buyer should not be able to see brand on search result")
        public T33167 evidenceT33167(){
            highlightElement(resultsearch);
            AllureAttachments.saveWebElement(getWebDriver(), resultsearch);
            return this;
