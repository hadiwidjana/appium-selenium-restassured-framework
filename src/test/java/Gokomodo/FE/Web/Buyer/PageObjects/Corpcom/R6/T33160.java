...
public class T33160 extends BuyerLoginCommerce1PageObject {
    //============== Login ==================//
    ...
    private WebElement Popupdetails;
        ...
        public T33160 InputEmail() throws InterruptedException {
            Thread.sleep(1000);
        ...
        public T33160 BtnLoginCorp() throws InterruptedException {
         ...
         public T33160 searchPrd() throws InterruptedException {
        ...
        public T33160 ChsPrd() throws InterruptedException {
        ...
        public T33160 clickprd() {
            highlightElement(clkprd);
            AllureAttachments.saveWebElement(getWebDriver(), clkprd);
            clkprd.click();
            return this;
        }
        @Step ("T33160 - the Buyer should be able to see the detail of brand popup")
          public T33160 evidenceT33160(){
                highlightElement(Popupdetails);
                AllureAttachments.saveWebElement(getWebDriver(), Popupdetails);
                return this;
