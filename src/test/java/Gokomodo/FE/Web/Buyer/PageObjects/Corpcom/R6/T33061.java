...
public class T33061 extends BuyerLoginCommerce1PageObject {
    ...
    public T33061 InputEmail() throws InterruptedException {
        Thread.sleep(1000);
    ...
    public T33061 BtnLoginCorp() throws InterruptedException {
    ...
    public T33061 clickLogoRFQBtnCorpcomm() {
    ...
    public T33061 inputRFQNameCorpcomm() throws InterruptedException {
    ...
    public T33061 clickTheRFQNameCorpcomm() {
...
//    }
    ...
    public T33061 clickViewCancelledCorpcomm() {
