...
public class T33045 extends BuyerLoginCommerce1PageObject {
    ...
    public T33045 InputEmail() throws InterruptedException {
        Thread.sleep(1000);
    ...
    public T33045 BtnLoginCorp() throws InterruptedException {
    ...
    public T33045 clickLogoRFQBtnCorpcomm() {
    ...
    public T33045 inquiryListClickCorpcomm() {
    ...
    public T33045 inquirychooseIPCorpcomm() throws InterruptedException {
    ...
    public T33045 clickRFQListCorpcomm() {
    ...
    public T33045 clickActionbtnCorpcomm() {
    ...
    public T33045 clickCancelBtnCorpcomm() {
    ...
    public T33045 inputReasonCancelCorpcomm() {
        highlightElement(inputReasonCancel);
        inputReasonCancel.sendKeys("testing testcase T33045");
        return this;
    }

    @Step("As a user click the cancel button")
    public T33045 clickCancelPopUpCorpcomm() throws Exception {
        highlightElement(clickCancelPopUp);
        clickCancelPopUp.click();
        Thread.sleep(3000);
        AllureAttachments.saveWebElement(getWebDriver(), clickCancelPopUp);
        Thread.sleep(3000);
        robotScreenCapture("ExpectedT33045");
        return this;
    }
