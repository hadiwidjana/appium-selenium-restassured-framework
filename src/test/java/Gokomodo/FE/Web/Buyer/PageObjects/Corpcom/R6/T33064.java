...
public class T33064 extends BuyerLoginCommerce1PageObject {
    ...
    public T33064 InputEmail() throws InterruptedException {
        Thread.sleep(1000);
    ...
    public T33064 BtnLoginCorp() throws InterruptedException {
    ...
    public T33064 clickLogoRFQBtnCorpcomm() {
    ...
    public T33064 inquiryListClickCorpcomm() {
    ...
    public T33064 inquirychoosePOCorpcomm() throws InterruptedException {
    ...
    public T33064 clickRFQListCorpcomm() {
