...
public class T33060 extends BuyerLoginCommerce1PageObject {
    ...
    private WebElement clickCloseViewCancel;
    ...
    public T33060 InputEmail() throws InterruptedException {
        Thread.sleep(1000);
    ...
    public T33060 BtnLoginCorp() throws InterruptedException {
    ...
    public T33060 clickLogoRFQBtnCorpcomm() {
    ...
    public T33060 inputRFQNameCorpcomm() throws InterruptedException {
    ...
    public T33060 clickTheRFQNameCorpcomm() {
...
//    }
    ...
    public T33060 clickViewCancelledCorpcomm() {
        highlightElement(clickViewCancelled);
        clickViewCancelled.click();
        return this;
    }

    @Step("As a user click close in view cancel icon button")
    public T33060 clickCloseViewCancelCorpcomm() throws Exception {
        highlightElement(clickCloseViewCancel);
        clickCloseViewCancel.click();
        Thread.sleep(3000);
        AllureAttachments.saveWebElement(getWebDriver(), clickCloseViewCancel);
        Thread.sleep(3000);
        robotScreenCapture("ExpectedT33060");
        return this;
    }
