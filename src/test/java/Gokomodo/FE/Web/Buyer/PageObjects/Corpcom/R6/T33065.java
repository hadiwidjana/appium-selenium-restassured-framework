...
public class T33065 extends BuyerLoginCommerce1PageObject {
    ...
    public T33065 InputEmail() throws InterruptedException {
        Thread.sleep(1000);
    ...
    public T33065 BtnLoginCorp() throws InterruptedException {
    ...
    public T33065 clickLogoRFQBtnCorpcomm() {
    ...
    public T33065 inquiryListClickCorpcomm() {
    ...
    public T33065 inquirychooseCancelledCorpcomm() throws InterruptedException {
    ...
    public T33065 clickRFQListCorpcomm() {
