...
public class T33068 extends BuyerLoginCommerce1PageObject {
    ...
    private WebElement inquirychooseCancelled;
    ...
    @FindBy(xpath = "//*[@id=\"root\"]/div/main/div/div[4]/div/div[2]")
    private WebElement containerDisableTC;
    ...
    public T33068 InputEmail() throws InterruptedException {
        Thread.sleep(1000);
    ...
    public T33068 BtnLoginCorp() throws InterruptedException {
    ...
    public T33068 clickLogoRFQBtnCorpcomm() {
    ...
    public T33068 clickUploadedbtnCorpcomm() throws InterruptedException {
    ...
    public T33068 inquiryListClickCorpcomm() {
    ...
    public T33068 inquirychooseCancelledCorpcomm() throws InterruptedException {
        highlightElement(inquirychooseCancelled);
        inquirychooseCancelled.click();
        Thread.sleep(4000);
        return this;
    }

    @Step("As a user choose click the RFQ detail")
    public T33068 clickRFQListCorpcomm() {
    ...
    public T33068 clickActionbtnCorpcomm() throws Exception {
        highlightElement(clickActionbtn);
        clickActionbtn.click();
        Thread.sleep(3000);
        AllureAttachments.saveWebElement(getWebDriver(), clickActionbtn);
        Thread.sleep(3000);
        robotScreenCapture("ExpectedT33068");
        return this;
    }

    @Step("As a user click the action button And teh cancel button will be disable")
    public T33068 containerDisableTCCorpcomm() throws Exception {
        highlightElement(containerDisableTC);
        containerDisableTC.click();
        Thread.sleep(3000);
        AllureAttachments.saveWebElement(getWebDriver(), containerDisableTC);
        Thread.sleep(3000);
        robotScreenCapture("ExpectedT33184");
        return this;
    }
