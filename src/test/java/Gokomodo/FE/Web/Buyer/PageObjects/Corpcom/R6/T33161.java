...
public class T33161 extends BuyerLoginCommerce1PageObject {
    //============== Login ==================//
    ...
    @FindBy(xpath = "/html/body/div[3]/div/div[1]/div/div/div[2]/div[2]/div[1]/div[2]/div[2]/small[3]")
    private WebElement btndwnld;


        @Step("As a user already input email")
        public T33161 InputEmail() throws InterruptedException {
            Thread.sleep(1000);
        ...
        public T33161 BtnLoginCorp() throws InterruptedException {
         ...
         public T33161 searchPrd() throws InterruptedException {
        ...
        public T33161 ChsPrd() throws InterruptedException {
        ...
        public T33161 clickprd() {
            highlightElement(clkprd);
            AllureAttachments.saveWebElement(getWebDriver(), clkprd);
            clkprd.click();
            return this;
        }
        @Step ("T33161 - the Buyer should be able to download attachment on brand details")
        public T33161 evidenceT33161(){
            highlightElement(btndwnld);
            AllureAttachments.saveWebElement(getWebDriver(), btndwnld);
            btndwnld.click();
            return this;
