...
public class CreateQuotationRFQ extends SellerPageLoginInitializer {
...
//    private WebElement checklistAll;
    ...
    public CreateQuotationRFQ InputEmailSeller() throws InterruptedException {
        Thread.sleep(1000);
    ...
    public CreateQuotationRFQ InputPasswordSeller(){
    ...
    public CreateQuotationRFQ btnLoginSeller(){
    ...
    public CreateQuotationRFQ QuotationListbtnSeller(){
    ...
    public CreateQuotationRFQ QuotationInputSeller() throws InterruptedException {
        highlightElement(QuotationInput);
        QuotationInput.sendKeys("RFQ/2022/09/34");
        Thread.sleep(2000);
        return this;
    }

    @Step("As a user click button Quotation list box")
    public CreateQuotationRFQ clickTheQuotationSeller() {
    ...
    public CreateQuotationRFQ radioBtnUsingXlsSeller() throws InterruptedException {
        Thread.sleep(3000);
    ...
    public CreateQuotationRFQ btnPopUpSureSeller() {
    ...
    public CreateQuotationRFQ uploadXlsSeller() throws InterruptedException {
        scrollDown700();
    ...
    public CreateQuotationRFQ btnOriginShipmentSeller() throws InterruptedException {
        Thread.sleep(3000);
        JavascriptExecutor js = (JavascriptExecutor) getWebDriver();
    ...
    public CreateQuotationRFQ btnChooseOriginShipmentSeller() {
    ...
    public CreateQuotationRFQ btnSaveAddressSeller() {
    ...
    public CreateQuotationRFQ inputNotesSeller() throws InterruptedException {
        Thread.sleep(3000);
        JavascriptExecutor js = (JavascriptExecutor) getWebDriver();
    ...
    public CreateQuotationRFQ btnSaveAddSeller() {
        highlightElement(btnSaveAdd);
        btnSaveAdd.click();
        return this;
    }

    public CreateQuotationRFQ btnSendQuoSeller() {
        highlightElement(btnSendQuo);
        btnSendQuo.click();
        return this;
    }

    public CreateQuotationRFQ btnSendQuoPopUpSeller() {
