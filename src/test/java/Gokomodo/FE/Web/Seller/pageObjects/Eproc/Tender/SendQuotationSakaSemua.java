...
public class SendQuotationSakaSemua extends SellerPageLoginInitializer {
    ...
    public SendQuotationSakaSemua InputEmailSeller() throws InterruptedException {
        Thread.sleep(1000);
    ...
    public SendQuotationSakaSemua InputPasswordSeller(){
    ...
    public SendQuotationSakaSemua btnLoginSeller(){
    ...
    public SendQuotationSakaSemua inquirylistButtonSeller(){
    ...
    public SendQuotationSakaSemua inputInquiryNameSeller() throws InterruptedException {
    ...
    public SendQuotationSakaSemua clickTheInquirySeller(){
    ...
    public SendQuotationSakaSemua clickBtnSendQuoSeller(){
    ...
    public SendQuotationSakaSemua clickBtnSendQuoPopupSeller(){
